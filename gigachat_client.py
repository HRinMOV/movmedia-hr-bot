    ...
    },
    {
        ...
        "parameters": {
            ...
            "properties": {
                ...
                "resume_link": {
                    "type": "string",
                    "description": "Ссылка на резюме кандидата, если он присылал ссылку. Если резюме прислано файлом (без ссылки) — всё равно указывай это поле, например значением 'получено файлом в Telegram'",
                },
                "portfolio_link": {
                    "type": "string",
