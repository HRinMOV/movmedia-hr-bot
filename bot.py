...
SENSITIVE_TOPICS_TEXT = (
    "Хороший вопрос. Такие детали обычно обсуждаются непосредственно с рекрутером на следующих этапах собеседования, чтобы вы получили актуальную информацию именно по вашей ситуации.\n\n"
